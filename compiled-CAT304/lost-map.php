...
include 'locations_modellost.php';
...
<html lang="en">
  ...
  <header>
        ...
        <h2 class="title">      Mark Location You Lost the Pet</h2>
        <nav class="navbar">
            <a href="lost.html">Done</a>
        </nav>
...
function initAutocomplete() {
  ...
  var url = 'locations_modellost.php?add_location&description=' + description + '&lat=' + lat + '&lng=' + lng;
