...
$query=mysqli_query($conn,"select * from petfound where id=$petid ");
//$row=mysqli_fetch_array($query);
$row=mysqli_fetch_array($query);
//echo $row['id'];

$petimage= "image/found/"."/".$row['petimage'];
...
<head>
  ...
  <script src="https://code.jquery.com/jquery-1.10.2.min.js"></script>
    ...
    <link rel="stylesheet" href="viewfound.css" />
...
<header>
        ...
        <nav class="navbar">
            <a href="displayfound.php">Back</a>
            <a href="found.html">Report Found Pet</a>
            <a href="foundmap">Search Nearby</a>
        </nav>
    ...
    <div class="row">
        <div class="col-md-5">
            ...
            <div class="project-info-box mt-0">
                <h5 class="btn btn-lg btn-warning" style="float:right";>Found</h5><br><br>
