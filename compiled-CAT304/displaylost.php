...
$stateResult = $db_handle->runQuery("SELECT DISTINCT state FROM petlost ORDER BY state ASC");
...
<head>
 ...
 <header>
        ...
        <nav class="navbar">
            ...
            <a href="lostnearby.php">Search Nearby</a>
        </nav>
...
<body>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-10 col-lg-8">
                <form method="POST" name="search" action="displaylost.php">
                    <div id="demo-grid">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="section-title title-left text-center text-lg-left">
                                        <h3 class="top-sep">Result Lost</h3>
                                    ...
                                    <div class="team-item" style="height:500px; width :300px" ;>
                                        <div class="mb-30 align-items-center">
                                            <span class="socials d-inline-block">
                                                <a href="viewlost.php?id=<?php echo $result[$key]['id']; ?>"
                                            ...
                                            <span class="img-holder d-inline-block" style=" size:2641 x 3974" ;>
                                                <a href="viewlost.php?id=<?php echo $result[$key]['id']; ?>"><img
                                                        src="image/lost/<?php echo $result[$key]['petimage']; ?>"
                                                        alt="Pet"></a?>
                                            </span>
                                        </div>
                                        <div class="team-content"style="font-size: 16px;" ;>
                                            <h5 class="mb-2"><?php echo  $result[$key]['petname']; ?></h5>
                                            <a style=color:black;>Lost in
    ...
    <div class="container" id="myDIV">
        ...
        <div class="row justify-content-center">
          ...
          $query=mysqli_query($conn,"SELECT *from petlost  ");
      
          while($res=mysqli_fetch_assoc($query)) { 
              $petimage= "image/lost/"."/".$res['petimage'];
                  ?>
            ...
            <div class="col-md-6 col-lg-4 mb-30">
                <div class="team-item" style="height:590px" ;>
                    <div class="mb-30 align-items-center">
                        <span class="socials d-inline-block">
                            <a href="viewlost.php?id=<?php echo $res['id']; ?>" class="zmdi zmdi-info-outline"></a>
                            <a href="https://api.whatsapp.com/send?phone=60<?php echo $res['phone']; ?> "
                                class="zmdi zmdi-whatsapp"></a>

                        </span>
                        <span class="img-holder d-inline-block" style=" size:2641 x 3974" ;>
                            <a href="viewlost.php?id=<?php echo $res['id']; ?>"><img src="<?php echo $petimage; ?>"
                                    alt="Pet"></a?>
                        </span>
                    </div>
                    <div class="team-content"style="font-size: 16px;" ;>
                        <h5 class="mb-2"><?php echo $res['petname']; ?></h5>
                        <a style=color:black;>Lost in <?php echo $res['state']; ?></a><br>
